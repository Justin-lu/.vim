...
exec "Snippet script <script type=\"text/javascript\" src=\"".st.et."\"> </script><CR>".st.et
exec "Snippet html <html> ".st.et."</html>"
...
exec "Snippet link <link rel=\"".st.et."\" href=\"".st.et."\" type=\"text/css\" charset=\"".st.et."\" />"
